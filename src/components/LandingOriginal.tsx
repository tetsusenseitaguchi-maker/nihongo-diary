// Backup of the original landing page — swap this back in page.tsx to revert.
...
export function LandingOriginal({ t, locale }: { t: T; locale: Locale }) {
  const features = [
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      >
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <LinkButton href="/signup" size="sm">{t("landing.nav.startFree")}</LinkButton>
          </div>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 h-full bg-gradient-to-b from-cream/40 via-cream/70 to-cream" aria-hidden />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <h1 className="font-serif text-4xl font-extrabold leading-[1.08] tracking-tight text-pine sm:text-5xl lg:text-6xl">
                {t("landing.hero.h1a")}
                <br />
                <span className="text-moss-600">{t("landing.hero.h1b")}</span>
              </h1>
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-ink/75">{t("landing.hero.lead")}</p>
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <LinkButton href="/signup" size="lg">
                  {t("landing.hero.ctaPrimary")} <Icon.arrow className="h-5 w-5" />
                </LinkButton>
                <LinkButton href="/write" variant="secondary" size="lg">{t("landing.hero.ctaSecondary")}</LinkButton>
              </div>
              <p className="mt-4 text-sm text-muted">{t("landing.hero.subtext")}</p>
            </div>
            <div className="relative">
              <Card className="genkou-soft relative overflow-hidden p-6 shadow-lift">
                <div className="mb-4 flex items-center justify-between">
                  <span className="text-xs font-bold uppercase tracking-wide text-muted">{t("landing.hero.cardLabel")}</span>
                ...
                <div className="flex items-start gap-3 rounded-2xl bg-mint/60 p-3">
                  ...
                  <p className="text-sm leading-relaxed text-ink/80">
                    ...
                    <span className="font-jp text-ink/50 line-through">かわいいでした</span>{" "}
                    <span className="text-moss">→</span>{" "}
                    <span className="font-jp font-semibold text-pine">かわいかったです</span>
                  </p>
                </div>
              </Card>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-serif text-3xl font-extrabold tracking-tight text-pine sm:text-4xl">{t("landing.problem.h2")}</h2>
          <p className="mt-4 text-lg leading-relaxed text-ink/70">{t("landing.problem.body")}</p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-4 font-serif text-3xl font-extrabold tracking-tight text-cream sm:text-4xl">{t("landing.solution.h2")}</h2>
              <p className="mt-4 text-lg leading-relaxed text-cream/80">{t("landing.solution.body")}</p>
              <ul className="mt-6 space-y-3">
                {[t("landing.solution.li1"), t("landing.solution.li2"), t("landing.solution.li3")].map((item) => (
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-4 font-serif text-3xl font-extrabold tracking-tight text-pine sm:text-4xl">{t("landing.features.h2")}</h2>
        </div>
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <Card key={f.title} className="p-6 transition-shadow hover:shadow-lift">
              ...
              <h3 className="mb-1.5 font-serif text-lg font-bold text-pine">{f.title}</h3>
      ...
      <section className="bg-sand/40">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-serif text-3xl font-extrabold tracking-tight text-pine sm:text-4xl">{t("landing.steps.h2")}</h2>
          </div>
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((s) => (
              <Card key={s.n} className="p-6">
                <span className="font-serif text-3xl font-extrabold text-moss/50">{s.n}</span>
                <h3 className="mb-1.5 mt-2 font-serif text-lg font-bold text-pine">{s.title}</h3>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-serif text-3xl font-extrabold tracking-tight text-pine sm:text-4xl">{t("landing.pricing.h2")}</h2>
        </div>
        <div className="mt-10">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-24 sm:px-6">
        <Card accent="none" className="genkou-soft relative overflow-hidden bg-pine p-10 text-center shadow-lift sm:p-14">
          <div className="relative">
            ...
            <p className="mx-auto mt-3 max-w-md text-lg text-cream/80">{t("landing.cta.body")}</p>
